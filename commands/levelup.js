								...
								addAchievement(user_profile, achievement_data,function(error){
									if (error) {
										...
										var embed_achievement = {
											title: fetchedUser.user.nickname ?? fetchedUser.user.username  + " получил новую ачивку!",
											color: 0x0099ff,			
											thumbnail: {
										...
										updateLevel(user_profile, function(error,updated_profile){
											if (error) {
												...
												var embed_levelup = {
													title: fetchedUser.user.nickname ?? fetchedUser.user.username  + " получил новый уровень!",
													color: 0x0099ff,			
													thumbnail: {
