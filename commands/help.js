		...
		async execute(interaction) {
			...
			var embed_help = {
				...
				fields: [	
					...
					{
						name: "/roll <dice_type>",
						value:"Кидает выбранный кубик и показывает результат в чате.",
					},
					{
						name: "/card",
						value:"Вытаскиывет случайную карту из колоды и показывает результат в чате.",
					},
					{
			...
			await interaction.reply({ content:`${fetchedUser.user}, для Вас весть от Хугинна:`, embeds: [embed_help], components: [component_buttons], ephemeral: true });
		},
};
