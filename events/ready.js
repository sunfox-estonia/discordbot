...
module.exports = {
	...
	execute(client) {
        database.connect(function(err) {
           ...
           * This command should be runned only ine time in 24h
           */
          ...
          if (timeCurrent.isBetween(timeLimitStart, timeLimitEnd)) {
            ...
            BotLogChannel.send({ content: `[PLAY2] Invites channel has not been cleared - current time is not within the limit.` });
          }
	},
};
